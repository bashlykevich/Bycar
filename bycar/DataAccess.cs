...
namespace bycar
{
    ...
    {
        DriveEntities objDataContext;
        spare_group root = null;
        unit u = null;
        int spid = 0;
        ...
        void DeleteRelatedBankAccount(int AccountID)
        {
        ...
        void NullizeRelatedIncomes(int AccountID)
        {
        ...
        void NullizeRelatedOutgoes(int AccountID)
        {
        ...
        void NullizeRelatedInvoices(int AccountID)
        {
     ...
     //       objDataContext.SaveChanges();
        ...
        public currency_rate getCurrencyRate(string CurrencyCode, DateTime dt)
        {
            ...
            List<currency_rate> rates = (from r in objDataContext.currency_rate 
                                         where (r.currency.code.Contains(CurrencyCode) 
                                                ...
                                                && r.rate_date.Day == dt.Day) select r).ToList();                        
            /*if (rates.Count == 0)
            {
        ...
        */
        ...
        bool AnaloguesAreEqual(int spareId1, int spareId2)
        {
        ...
        List<SpareView> getEqualAnalogues(int spareId)
        {
            List<SpareView> items = new List<SpareView>();
        ...
        */
        ...
        List<string> getChildGroups(int GroupID)
        {
            List<string> items = new List<string>();
        ...
        List<spare_group> getChildGroupsByGroupID(int parentID)
        {
        ...
        */
        ...
        int GetGroupIDByCode1C(string Code1C)
        {
        ...
        int DeleteSpareAnalogues(int spareId)
        {
            int deleted = 0;
        ...
        bool SpareGroupNameExist(string groupName)
        {            
        ...
        void moveSparesInGroupToRoot(int groupId)
        {
            int RootID = 1;
       ...
       // }
        ...
        List<SpareView> getSparesByGroupID(int GroupID)
        {
        ...
        {            
            var items = from s in objDataContext.SpareInSpareOutgoViews
                        ...
                        &&  s.OutgoDate.Value <= dto 
                        && s.spare_id == SpareID)                        
                        orderby s.OutgoDate.Value select s;
            return items.ToList();
        }
        ...
        public void OutOfferingDelete(int offeringId)
        {
            ...
            if(offering.spare_in_spare_incomeReference.Value != null)
            {
                ...
                if(sin != null && outgo.isGhost != 1)
                    sin.QRest += (int)offering.quantity;            
            }
            objDataContext.DeleteObject(offering);
            objDataContext.SaveChanges();
        }
