...
{
    /// <summary>
    /// Логика взаимодействия для ReportViewSpareOutgoTTN.xaml
    /// </summary>
    public partial class ReportViewSpareOutgoTTN : Window
    {
        ...
        private void Window_Activated(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                StreamReader reader = new StreamReader(new FileStream(@"Templates\SpareOutgoTTNReport.xaml", FileMode.Open, FileAccess.Read));
                ...
                data.ReportDocumentValues.Add("customer", Outgo.Account);
