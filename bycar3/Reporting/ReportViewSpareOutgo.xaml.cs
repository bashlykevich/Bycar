...
{
    /// <summary>
    /// Логика взаимодействия для ReportViewSpareOutgo.xaml
    /// </summary>
    public partial class ReportViewSpareOutgo : Window
    {
        ...
        private void Window_Activated(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                StreamReader reader = new StreamReader(new FileStream(@"Templates\SpareOutgoReport.xaml", FileMode.Open, FileAccess.Read));
